...
public class S3Helper {
	...
	public static void main(String[] args) throws IOException {
		...
		s3.connect();
		s3.listBuckets();
		s3.listObjects("aclchaves1");
		//s3.createBucket("livros - " + UUID.randomUUID());
		s3.listBuckets();
		
		byte[] bytes = new String("Andre Chaves Lima").getBytes();
		s3.putFile("aclchaves1", "Teste", "nome.txt", "plain/text", bytes);
		s3.listObjects("aclchaves1");
		
		String s = s3.getFile("aclchaves1", "Teste/nome.txt");
